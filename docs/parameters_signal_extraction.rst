...
*  :reditalic:`cytoring_region_dist` :gray:`(1x2 integer array)` --- Distances (in pixels) between the cytoplasmic ring and the ellipse contour.
   ...
   Inner and outer boundaries of the cytoplasmic ring.

*  :reditalic:`nuc_region_dist` :gray:`(integer)` --- Distances (in pixels) between the nucleus and the ellipse contour.

*  :reditalic:`background_dist` :gray:`(integer)` --- Distances (in pixels) between the image background and the ellipse contour.
...
*  :greenitalic:`outlier_percentile` :gray:`(double | advanced parameter)` --- Outlier percentiles (0 to 50) of intensities.
